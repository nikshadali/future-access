...
import { AnimatedButton, FinanceButton } from "./FinanceButton";
    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="mx-auto max-w-6xl px-6 py-28 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1 text-sm text-primary backdrop-blur"
        >
