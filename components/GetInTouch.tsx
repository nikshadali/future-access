...
<TextEffectWithExit>
     Whether you're looking to transform your ERP, optimize accounting,
          ...
          <div className="space-y-4 pt-6">
            <ContactItem icon={<Mail size={20} />} name="Email"  text="contact@bftconsultants.com" />
            <ContactItem icon={<Phone size={20} />} name="Phone" text="+971-503013473" />
            <ContactItem icon={<MapPin size={20} />} name="Address" text="Business Center, SHAMS freezone, UAE" />
          </div>
        </div>
