...
export default async function ServicePage({ params }: Props) {
  ...
  return (
    <div>
      {service.sections.includes("hero") && <HeroSection service={service} />}
      ...
      {service.sections.includes("faq") && service.faq && (
        <FAQSection title={service.faq.title} faqs={service.faq.faqs} />
      )}

      {service.sections.includes("cta") && <ServiceCTASection />}
    </div>
  );
}
